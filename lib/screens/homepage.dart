                          ...
                          children: [
                            ...
                            CustomTimeButton(
                              ...
                              onPressed: () async {
                                ...
                                //   stopVideoRecording();
                                //   print('stop recording');
                                //   clipCon.addFullSession(
                                //     SaveAllFile(
                                //       file: File(videoPath!),
                                //     ),
                                //   );
                                //   print(clipCon.saveFullSession.toString());
                                ...
                                //           .toString());
                                //   double conDuration = controller
                                //       .value.duration.inSeconds
                                //       .toDouble();
                                //   double last30Sec = (conDuration - 30.0);
                                //   LastClipController().saveLastClipVideo(
                                //     startValue: last30Sec,
                                //     endValue: conDuration,
                                //     onSave: (outputPath) async {
                                //       debugPrint('OUTPUT PATH: $outputPath');
                                //       clipCon.addLastSecond(SaveLastSecondFile(
                                //           lastSecondfile: File(outputPath)));
